...
function App() {
  ...
  // Screenshare/camera are only offered during voice sessions — stop any
  // active capture when the agent turns off
  useEffect(() => {
    if (!voiceAgent.active && capture.mode) {
      capture.stopCapture();
    }
  }, [voiceAgent.active, capture.mode, capture.stopCapture]);
